...
export default function Previewdata({data}) {
  ...
  {
    data?(
      <div className='mx-1 mt-8 lg:px-[8rem] py-8 flex flex-col gap-2 tracking-[.4px] bg-slate-200 shadow-lg shadow-indigo-500/40  rounded-lg'>
        {/* details */}
        ...
        <div className='lg:min-w-[25%] min-w-[50%] flex flex-col  p-2 md:p-2 lg:p-2 '>
            <div className='flex flex-col gap-1'>
                <div>
                    ...
                    <div className='flex gap-2 lg:text-sm text-xs md:items-start md:justify-start lg:items-start lg:justify-start items-center justify-center lg:tracking-[6px]'>
                        <p className=''>NO:{data.invoiceNumber}</p>
                        <span className='hidden w-px h-6 bg-red-300 md:block'></span>
                    <p className='flex items-center justify-center text-gray-500'>{data.invoiceDate}</p>
                    </div>
                </div>
                <div className=''>
                <div className='mt-5 '>
